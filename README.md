...
3. Enable SSH and enter your WiFi credentials during the flash setup
   
5. SSH into the Pi and run the setup script in /firmware/setup.sh
   
7. Follow the Google OAuth flow to authorize access to your personal tasks
